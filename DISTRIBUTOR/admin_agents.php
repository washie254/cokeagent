		  ...
		  <div class="collapse navbar-collapse text-center" id="navbarsExample09">
			<ul class="navbar-nav ml-auto">
			  <li class="nav-item active">
			   ...
			   <li class="nav-item"><a class="nav-link" href="admin_distributors.php">Distributors</a></li>
			   <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown03">
						<li><a class="dropdown-item" href="admin_agents_reports.php">Agent Reports</a></li>
						<li><a class="dropdown-item" href="admin_distributors_reports.php">Distributor Reports</a></li>
					</ul>
			  </li>
			</ul>
		  </div>
    ...
    <hr><br>
       ...
       <div style="padding: 6px 12px; border: 1px solid #ccc;">
        ...
        <form method="post" action="admin_agents.php">
          ...
          <div class="form-group">
              <label for="exampleInputEmail1">Agent's First Name</label>
              <input type="text" class="form-control" name="fname" placeholder="Enter Firstname">
          </div>
          <div class="form-group">
              <label for="exampleInputEmail1">Agent's Last Name</label>
              <input type="text" class="form-control" name="lname" placeholder="Enter Last name">
          </div>
          <div class="form-group">
              <label for="exampleInputEmail1">Agent's Sirname</label>
              <input type="text" class="form-control" name="sname" placeholder="Enter Sirname">
          </div>
          <div class="form-group">
