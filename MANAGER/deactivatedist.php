...
<section class="section intro">
    ...
    ?>
    <h2>DEACTIVATE [ <b> <span style="color:red;"><?=$distname?></span> </b> ]</h2> 
    <hr><br>
       ...
       <div style="padding: 6px 12px; border: 1px solid #ccc;">
        ...
        <form method="post" action="approvedist.php">
          ...
          <button type="submit" class="btn btn-danger" name="deact_dist" style="width:100%;"><b>DEACTIVATE DISTRIBUTOR</b></button>
        </form>
      </div>
	</div>
</section>
