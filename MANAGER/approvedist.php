       ...
       <div style="padding: 6px 12px; border: 1px solid #ccc;">
        ...
        <form method="post" action="approvedist.php">
          ...
          <div class="form-group">
              ...
              <label for="exampleInputEmail1">Dist..............#: <span style="color:green;"><?=$distid?></span> </label><br>
              <label for="exampleInputEmail1">Distribution name: <span style="color:green;"><?=$distname?></span></label><br>
              <label for="exampleInputEmail1">Email..............: <span style="color:green;"><?=$distemail?></span></label><br>
              <label for="exampleInputEmail1">TEL..................: <span style="color:green;"><?=$distel?></span></label><br>
              <label for="exampleInputEmail1">Location.........: <span style="color:green;"><?=$distlocation?></span></label><br>
          </div>
          <div class="form-group">
              <label for="exampleInputPassword1">Provide Remarks if any</label>
              <textarea type="text" class="form-control" name="remarks"  placeholder="Give some brief remarksif any" ></textarea>
          </div>
          <button type="submit" class="btn btn-success" name="approve_dist" style="width:100%;"><b>APPROVE DISTRIBUTOR ACCOUNT</b></button>
        </form>
      </div>
	</div>
</section>
