       ...
       <div style="padding: 6px 12px; border: 1px solid #ccc;">
        ...
        <form method="post" action="approvedist.php">
          ...
          <div class="form-group">
              ...
              <textarea type="text" class="form-control" name="reason"  placeholder="Provide reason for deactivation" ></textarea>
          </div>
          <button type="submit" class="btn btn-success" name="act_dist" style="width:100%;"><b>ACTIVATE DISTRIBUTOR</b></button>
        </form>
      </div>
	</div>
</section>
